...
# -*- coding: utf-8 -*-
"""
Created on Thu Jun 24 20:52:13 2021
...
ax.set_title("Standardized Infection Ratio for Clostridium difficile infections for Long Term Acute Care Hospitals, 2015", fontsize = 30)
ax.set_axis_off()
for idx, row in gdf.iterrows():plt.annotate(s=row['state'], xy=row['coords'], horizontalalignment='center')