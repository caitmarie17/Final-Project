...
# -*- coding: utf-8 -*-
"""
Created on Thu Jun 24 18:44:25 2021
...
ax.set_title("All Healthcare Associated Infections for Acute Care Hospitals, 2015", fontsize = 30)
ax.set_axis_off()
for idx, row in gdf.iterrows():plt.annotate(s=row['state'], xy=row['coords'], horizontalalignment='center')
