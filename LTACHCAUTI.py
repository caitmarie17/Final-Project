...
# -*- coding: utf-8 -*-
"""
Created on Thu Jun 24 20:57:43 2021
...
#print(plate)
ax=plate.plot(column=ft,scheme="fisher_jenks",k=8,cmap="Greens",legend=True,alpha=0.8,linewidth=1,figsize=(50,25))
ax.set_title("Standardized Infection Ratio for Catheter Associated Urinary Tract Infections for Long Term Acute Care Hospitals, 2015", fontsize = 30)
ax.set_axis_off()
for idx, row in gdf.iterrows():plt.annotate(s=row['state'], xy=row['coords'], horizontalalignment='center')